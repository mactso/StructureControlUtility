...
public class MyConfig {
	...
	public static final int DEFAULT_GLOOM_ALPHA_PERCENT  = 91;  // 91% opaque, 9% transparent
	...
	public static class Common {
		...
		public Common(ForgeConfigSpec.Builder builder) {
			builder.push("Structure Control Utility");
			...
			builder.push("Structure Protection Values");
